<%@ Page Language="C#" AutoEventWireup="true" CodeFile="author.aspx.cs" Inherits="author" StylesheetTheme="Theme1"  %>
...
<table border="0" cellpadding="0" cellspacing="0" width="1036" id="table1">
	...
	<tr>
		<td align="left" valign="top">
            Author ID</td>
		<td align="left" valign="top" style="width: 155px"><asp:TextBox ID="TxtAuthorId" runat="server" Width="150px" BackColor="WhiteSmoke" ReadOnly="True"></asp:TextBox></td>
	...
	<tr>
		...
		<td align="left" valign="top" style="width: 155px">
            <asp:TextBox ID="TxtAuthorName" runat="server" Width="150px"></asp:TextBox></td>
		<td align="left" valign="top">&nbsp;</td>
		<td align="left" valign="top" style="width: 116px">
            Year Born</td>
		<td align="left" valign="top">
	...
	<tr>
		...
		<td align="left" valign="top">
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 155px; height: 13px;" valign="top">
                                    </td>
                                <td align="left" valign="top" style="height: 13px">
                                </td>
                                <td align="left" style="width: 116px; height: 13px;" valign="top">
                                    </td>
                                <td align="left" valign="top" style="height: 13px">
                                    </td>
                            </tr>
