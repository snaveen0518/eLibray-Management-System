<%@ Page Language="C#" AutoEventWireup="true" CodeFile="book_update.aspx.cs" Inherits="book_update"  StylesheetTheme="Theme1" %>
					...
					<tr>
						<td style="height: 16px" colspan="6">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<br />
                           ...
                           <span id="span_booktitle" runat="server" >
                            ...
                            <br />
                            Do you want to add more books then <a href= "book.aspx?mode=new">Click</a> here<br />
                        </td>
					</tr>
					<tr>
