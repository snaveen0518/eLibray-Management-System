...
<head id="Head1" runat="server">
    ...
    <title>Find Book</title>
        ...
        function  FillRID(lnkRID)
        {
            ...
            opener.document.fh.TxtBookId.value =lnkRID;
            self.close();
    ...
    <div><table>
        ...
        <tr>
            ...
            <td style="width: 343px">
                <b><font size="2" face="Arial">Book Title</font></b><asp:TextBox ID="TxtFirstName" runat="server" MaxLength="100" Width="82px" Font-Names="Arial"></asp:TextBox>
