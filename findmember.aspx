<%@ Page Language="C#" AutoEventWireup="true" CodeFile="findmember.aspx.cs" Inherits="findmember" %>
...
<head id="Head1" runat="server">
    ...
    <title>Find Member</title>
        ...
        function  FillRID(lnkRID)
        {
            ...
            opener.document.fh.TxtMemID.value =lnkRID;
            self.close();
...
<body>
    ...
    <div><table>
        <tr>
            ...
            <td colspan="5">
                <asp:Label ID="Label1" runat="server" Text="Search for book" Width="257px" Font-Bold="True" Font-Names="Arial" Font-Size="12pt"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" style="width: 126px">
                <b>
                <asp:Label ID="lblcopyfrom" runat="server" Text="Book" Width="100px" Font-Names="Arial" Font-Size="10pt"></asp:Label>
				</b></td>
            ...
            <td style="width: 343px">
                <b><font size="2" face="Arial">Title </font></b><asp:TextBox ID="TxtFirstName" runat="server" MaxLength="100" Width="82px" Font-Names="Arial"></asp:TextBox>
                <b><font face="Arial" size="2">ISBN </font></b>
                ...
                <div class="PINCODEGridDiv">
                    <asp:GridView ID="gvTeleVerification" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRID" runat="server" Text='<%#Eval("BookID")%>'></asp:LinkButton>
                                </ItemTemplate>
                                <HeaderTemplate>
                                    Member ID
                                </HeaderTemplate>
