<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_category.aspx.cs" Inherits="member_category"   StylesheetTheme="Theme1"  %>
...
<table border="0" cellpadding="0" cellspacing="0" width="1036" id="table1">
	<tr>
		...
		<table border="0" cellspacing="0" width="100%" id="table2">
			<tr>
				<td><asp:Button ID="BtnSearchUser" runat="server" Text="Search User" Width="160px" onclick="BtnSearchUser_Click" /></td>
			</tr>
			<tr>
				<td><asp:Button ID="BtnNewUser" runat="server" Text="New User" Width="160px" onclick="BtnNewUser_Click" /></td>
			</tr>
			<tr>
				<td style="height: 18px"><asp:Button ID="BtnMemberCategory" runat="server" Text="Member Category" Width="160px" onclick="BtnMemberCategory_Click" /></td>
			</tr>
			<tr>
				<td><asp:Button ID="BtnChangePassword" runat="server" Text="Change Password" Width="160px" onclick="BtnChangePassword_Click" /></td>
			</tr>
            <tr>
                <td>
                    </td>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            ...
                            <asp:Button ID="BtnNewCategory" runat="server" Text="New Category" Width="112px" onclick="BtnNewCategory_Click" /></td>
					</tr>
					<tr>
