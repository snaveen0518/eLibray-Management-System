<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_category_details.aspx.cs" Inherits="member_category_details" StylesheetTheme="Theme1" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="1036" id="table1">
				...
				<br />
					<tr>
						<td colspan="6" style="height: 22px; background-color: khaki;">
                            <strong>Member Category Matser</strong> &nbsp;&nbsp;
                        </td>
					</tr>
					<tr>
	...
	<tr>
		<td align="left" valign="top">
            Category ID</td>
		<td align="left" valign="top" style="width: 155px"><asp:TextBox ID="TxtCategoryID" runat="server" Width="150px" BackColor="WhiteSmoke" ReadOnly="True"></asp:TextBox></td>
	...
	<tr>
		...
		<td align="left" valign="top" style="width: 155px">
            <asp:TextBox ID="TxtCategoryType" runat="server" Width="150px"></asp:TextBox></td>
		<td align="left" valign="top">&nbsp;</td>
		<td align="left" valign="top" style="width: 116px">
                                    </td>
		<td align="left" valign="top">
	...
	<tr>
		<td align="left" valign="top">
            No of Books</td>
		<td align="left" valign="top" style="width: 155px">
            <asp:TextBox ID="TxtNoOfBook" runat="server" Width="150px"></asp:TextBox></td>
		<td align="left" valign="top"></td>
		<td align="left" valign="top" style="width: 116px">
            No of Days</td>
		<td align="left" valign="top">
            <asp:TextBox ID="TxtNoOfDays" runat="server" Width="150px"></asp:TextBox></td>
	</tr>
	<tr>
		<td align="left" valign="top">
            Late Fine</td>
		...
		<td align="left" valign="top" style="width: 116px">
            Deposit Amount</td>
		<td align="left" valign="top">
            <asp:TextBox ID="TxtDepositAmount" runat="server" Width="150px"></asp:TextBox></td>
	</tr>
	<tr>
		<td align="left" valign="top">
            Renew Fees</td>
		<td align="left" valign="top" style="width: 155px">
            <asp:TextBox ID="TxtRenewFees" runat="server" Width="150px"></asp:TextBox></td>
		<td align="left" valign="top"></td>
