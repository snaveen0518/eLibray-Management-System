<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_update.aspx.cs" Inherits="member_update"   StylesheetTheme="Theme1"  %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            ...
                            <br />
                            <br />
                            <strong>New Member added successfully.</strong><br />
                        </td>
					</tr>
					<tr>
						<td style="height: 16px" colspan="6">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                            ...
                            <br />
                            <br />
                            Member ID :&nbsp;<strong><span id="span_memid" runat="server" ></span></strong><br />
                            <br />
                            Member : <strong>
                            
                           <span id="span_memname" runat="server" >
                            
                            </span>
                            
                            </strong><br />
                            <br />
                            Do you want to add more member then <a href= "member.aspx?mode=new">Click</a> here<br />
                        </td>
					</tr>
					<tr>
