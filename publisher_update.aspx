<%@ Page Language="C#" AutoEventWireup="true" CodeFile="publisher_update.aspx.cs" Inherits="publisher_update"  StylesheetTheme="Theme1"  %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					...
					<tr>
						<td style="height: 16px" colspan="6">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<br />
                            ...
                            <br />
                            Pub ID : <strong>
                            <span id="span_pubid" runat="server" >
                            ...
                            <br />
                            Publishers Name : <strong>
                            
                           <span id="span_pubname" runat="server" >
                            
                            </span>
                            
                            </strong><br />
                            <br />
                            Do you want to add more publishers then <a href= "publisher.aspx?mode=new">Click</a> here<br />
                        </td>
					</tr>
					<tr>
