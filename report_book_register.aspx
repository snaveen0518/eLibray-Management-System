<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report_book_register.aspx.cs" Inherits="reports_book_stock" StylesheetTheme="Theme1" %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>Report - Book Register</strong></td>
					</tr>
					<tr>
