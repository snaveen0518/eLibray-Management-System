<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report_member_register.aspx.cs" Inherits="report_member_register" StylesheetTheme="Theme1" %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>Report - Member Register</strong></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="height: 16px" colspan="6">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                Font-Bold="False" Font-Size="9pt" ForeColor="Black" GridLines="None"  OnPageIndexChanging="GridView1_PageIndexChanging" ShowFooter="True">
