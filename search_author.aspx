<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_author.aspx.cs" Inherits="search_author"   StylesheetTheme="Theme1"%>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>
                            Search Authors</strong><br />
                            Au ID
                            <asp:TextBox ID="TxtAuID" runat="server" Width="96px"></asp:TextBox>&nbsp; Authors
