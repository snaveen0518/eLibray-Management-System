<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_book.aspx.cs" Inherits="search_book" StylesheetTheme="Theme1"%>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>
                            Search Books</strong><br />
                            ISBN
                            <asp:TextBox ID="TxtISBN" runat="server" Width="96px"></asp:TextBox>
                            Title
					...
					<tr>
						<td style="height: 16px" colspan="6">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                Font-Bold="False" Font-Size="9pt" ForeColor="Black" GridLines="None" OnRowDataBound ="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowFooter="True">
