<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_library_card.aspx.cs" Inherits="search_library_card"  StylesheetTheme="Theme1" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="1036" id="table1">
	<tr>
		...
		<table border="0" cellspacing="0" width="100%" id="table2">
			<tr>
				<td><asp:Button ID="BtnSearchLibCard" runat="server" Text="Search Library Card" Width="160px" onclick="BtnSearchLibCard_Click" /></td>
			</tr>
			<tr>
				<td><asp:Button ID="BtnNewBook" runat="server" Text="New Library Card" Width="160px" onclick="BtnNewBook_Click"/></td>
			</tr>
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>
                            Search Library Card</strong><br />
                            Lib Card ID
                            <asp:TextBox ID="TxtLibCardID" runat="server" Width="96px"></asp:TextBox>
                            &nbsp; Member ID
