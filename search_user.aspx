<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_user.aspx.cs" Inherits="search_user"  StylesheetTheme="Theme1" %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>
                            Search Users</strong><br />
                            User ID
                            <asp:TextBox ID="TxtUserID" runat="server" Width="96px"></asp:TextBox>
                            &nbsp; Name
