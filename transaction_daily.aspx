<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transaction_daily.aspx.cs" Inherits="transaction_daily"  StylesheetTheme="Theme1" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="1036" id="table1">
	<tr>
		...
		<table border="0" cellspacing="0" width="100%" id="table2">
			<tr>
				<td><asp:Button ID="BtnTransaction1" runat="server" Text="Show Transaction" Width="160px" onclick="BtnTransaction1_Click" /></td>
			</tr>
			<tr>
				<td><asp:Button ID="BtnIssueBook" runat="server" Text="Issue Book" Width="160px" onclick="BtnIssueBook_Click" /></td>
			</tr>
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            <strong>Library Transaction</strong><br />
