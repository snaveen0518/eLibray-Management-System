<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_update.aspx.cs" Inherits="user_update"   StylesheetTheme="Theme1"  %>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="table4" >
					<tr>
						<td colspan="6" style="height: 16px">
                            ...
                            <br />
                            <br />
                            <strong>New user added successfully.</strong><br />
                        </td>
					</tr>
					<tr>
						<td style="height: 16px" colspan="6">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                            ...
                            <br />
                            <br />
                            User ID :&nbsp;<strong><span id="span_userid" runat="server" ></span></strong><br />
                            <br />
                            User Name : <strong>
                            
                           <span id="span_username" runat="server" >
                            
                            </span>
                            
                            </strong><br />
                            <br />
                            Do you want to add more users then <a href= "user.aspx?mode=new">Click</a> here<br />
                        </td>
					</tr>
					<tr>
